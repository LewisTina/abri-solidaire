...
export default function AnnounceSmall(props: Announce) {
    const {image, Title, startDate, endDate, address} = props
    return (
        <div className="rounded-lg bg-white dark:bg-black w-full h-20 my-2 flex overflow-hidden cursor-pointer">
