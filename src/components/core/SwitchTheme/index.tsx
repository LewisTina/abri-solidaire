...
export default function SwitchTheme() {
  ...
  return (
    <div className={`relative inline-block text-left z-50 ${style.themeMenu}`} style={{textTransform: "capitalize"}} id="theme-menu">
      <div className={style.preview}>
        <button 
          type="button"
          className="flex w-full items-center gap-x-1.5 rounded-md text-primary px-3 text-sm font-semibold" id="menu-button" 
          aria-expanded="true"
          aria-haspopup="true"
      ...
      {
        isOpen &&
        <div className={`absolute left-0 bottom-10 z-10 mt-5 w-48 origin-bottom-left rounded-md bg-gray-100 dark:bg-gray-900 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${style.menuButton}`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
